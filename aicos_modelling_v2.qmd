...
n_arts_df <- read_csv("output/metrics_binary-model_n-art.csv")
cross_val_df <- read_csv("output/cross-val_bm_metrics_nov24.csv")
...
odm_mets <- read_csv("output/odm_metrics_may25.csv")
bm_mets <- read_csv("output/bm_metrics_nov24.csv")
...
kable(mets_table, "html") |> 
  cat(file = file.path(tables_out, "n-arts_model-metrics.html"))
...
kable(cross_val_tab, "html") |> 
  cat(file = file.path(tables_out, "crossval_metrics.html"))
```
...
kable(bm_mets_out, "html") |> 
  cat(file = file.path(tables_out, "bm_metrics.html"))
...
kable(odm_mets_tab)kable(odm_mets_tab, "html") |> 
  cat(file = file.path(tables_out, "outcome-domain-model_metrics.html"))
```
