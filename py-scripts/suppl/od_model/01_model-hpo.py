...
## LOGGING SETUP
logging.basicConfig(
    filename=join(logs_dir, 'hpo_2nd.log'),  # Log file name
...
train_data, eval_data = set_train_eval(50, seed_no, eval_prop = 0)
...
for trial in best_run.backend.trials:
    logger.info(f"Trial {trial.number} | Objective value: {trial.value} | Hyperparameters: {trial.params}")
