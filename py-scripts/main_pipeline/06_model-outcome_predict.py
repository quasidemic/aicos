...
## LOGGING SETUP
logging.basicConfig(
    filename=join(logs_dir, 'predict_binary_20241030.log'),  # Log file name
...
ids_use, train_data, eval_data = set_train_eval(n, seed_no, labels)
...
# Write to file
out_path = join(output_dir, "report_binary-model_final.json")

with open(out_path, 'w') as f:
    json.dump(report, f)

# Save model
modeloutp = join(models_dir, 'binary_model')
...
# write to file
predict_outp = join(output_dir, 'outcome-notoutcome_predictions.csv')
