...
## LOGGING SETUP
logging.basicConfig(
    filename=join(logs_dir, 'hpo_binary-model_nov24_3.log'),  # Log file name
...
# Run HP opt
best_run = trainer.hyperparameter_search(direction="maximize", hp_space=hp_space, n_trials=10, sampler=TPESampler(seed=3333))

# store trials
trials_out = join(output_dir, 'hpo_trials-3.txt')
