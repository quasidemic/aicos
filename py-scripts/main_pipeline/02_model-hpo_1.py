...
## LOGGING SETUP
logging.basicConfig(
    filename=join(logs_dir, 'hpo_binary-model_nov24_1.log'),  # Log file name
...
# Run HP opt
best_run = trainer.hyperparameter_search(direction="maximize", hp_space=hp_space, n_trials=10, sampler=TPESampler(seed=1111))

# store trials
trials_out = join(output_dir, 'hpo_trials-1.txt')
